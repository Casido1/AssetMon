...
namespace AssetMon.Services.Interface
{
    public interface IVehicleService
    {
        ...
        Task<(ResultDTO<IEnumerable<VehicleDTO>> vehicles, MetaData metaData)> GetVehiclesByUserIdAsync(string userId, VehicleParameters vehicleParameters, bool trackChanges);
